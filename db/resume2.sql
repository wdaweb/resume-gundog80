...
(1, '履歷1', 1, 20, 4, '1,6,7', '1,2,3'),
(2, '履歷2', 1, 19, 3, '6', '2,3,4');
...
INSERT INTO `userbasicdata` (`id`, `name`, `photoPath`) VALUES
(1, '林昱賢', './img/Coffee-goods_17.jpg');
...
(6, 1, '  測試-公司名稱    ', '  一般員工        ', 5, '2010-12-10', '2015-12-23', '										測試-職務說明			adsddsdfs							'),
